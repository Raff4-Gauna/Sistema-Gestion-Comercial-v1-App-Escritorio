    ...
    public partial class frmProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            foreach (Proveedor item in Lista)
            {
                ...
                dgvdata.Rows.Add(new object[] {"", item.IdProveedor, item.Documento, item.RazonSocial, item.Correo, item.Telefono, item.Notas,
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdProveedor == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    dgvdata.Rows.Add(new object[] {"", idgenerado, txtdocumento.Text, txtnombrecompleto.Text, txtcorreo.Text, txttelefono.Text, txtNotas.Text,
        ...
        // Sumar todos los Proveedores
        public void SumarProveedores()
        {
            int Total = 0;
